...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(248, 195);
			...
			this->label1->Text = L"студент IIIк";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(293, 73);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(166, 20);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Мартынюк Полина";
			...
			this->ClientSize = System::Drawing::Size(544, 312);
