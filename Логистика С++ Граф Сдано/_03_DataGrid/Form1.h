...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(464, 37);
			...
			this->button2->Location = System::Drawing::Point(1026, 549);
			...
			this->menuStrip1->Size = System::Drawing::Size(1152, 24);
			...
			this->dataGridView1->Size = System::Drawing::Size(565, 199);
			...
			this->pictureBox1->Location = System::Drawing::Point(599, 87);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(501, 407);
			...
			this->dataGridView2->Location = System::Drawing::Point(12, 311);
			...
			this->dataGridView2->Size = System::Drawing::Size(565, 212);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(256, 35);
			...
			this->ClientSize = System::Drawing::Size(1152, 582);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //------------PARAMETERS ----------------
			  ...
			  while (ed<edges)
			  {
				  ...
				  if ((i!=j)&&(MAS[i][j]==0)) {
					...
					/*for(int i = 0; i < n; i++){
						  for (int j = 0; j < n; j++){
							  //int  MAS[i][j] = 0 + rand() % 1;
							  MAS[i][j] = (rand() % 2);
							  if (i==j) MAS[i][j] = 0;
							  else {MAS[j][i] = MAS[i][j];
									ed++;
									//fl++;
							  }
							  //MAS[i][j] = MAS[j][i];
			...
			this ->dataGridView2->Columns[fl]->HeaderText = st;	
				...
				Pen ^mypen = gcnew Pen (col -> Black,2);
